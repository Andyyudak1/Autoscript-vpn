...
Name=$(curl -sS https://raw.githubusercontent.com/Andyyudak1/Autoscript-vpn/main/izin | grep $MYIP | awk '{print $2}')
Exp=$(curl -sS https://raw.githubusercontent.com/Andyyudak1/Autoscript-vpn/main/izin | grep $MYIP | awk '{print $3}')
